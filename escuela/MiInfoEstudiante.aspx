<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MiInfoEstudiante.aspx.cs" Inherits="escuela.MiInfoEstudiante" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="sidebar-container">
            ...
            <div class="menu">
                <a href="MiInfoEstudiante.aspx" class="d-block p-3 text-primary"><i class="fas fa-user mr-2 lead"></i> Mi información</a>
                <a href="IndexEstudiante.aspx" class="d-block p-3 text-muted"><i class="fas fa-book-open mr-2 lead"></i> Calificaciones</a>
            </div>
        </div>
                        ...
                        <ul class="navbar-nav ml-auto">
                            <li class="nav-item dropdown font-weight-bold">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="MiInfoEstudiante.aspx"><i class="fas fa-calendar-alt lead"></i> Mi información</a>
                                    <a class="dropdown-item" href="IndexEstudiante.aspx"><i class="fas fa-user mr-2 lead"></i> Calificaciones</a>
                                    <div class="dropdown-divider"></div>
                            ...
                            <div class="col-sm-8 col-md-6">
                                <div class="frm-container">
                                    <div class="input-group my-2">
                                        <label for="txtCarnet" class="mr-2">Carnet:</label>
                                        <asp:TextBox ID="txtCarnet" runat="server" CssClass="form-control" name="txtCarnet" placeholder="2018LR601" Enabled="false"></asp:TextBox>
                                    </div>
                                    ...
                                    <div class="input-group my-4">
                                        <label for="txtResponsableNombre" class="mr-2">Resposable Nombre:</label>
                                        <asp:TextBox ID="txtResponsableNombre" runat="server" CssClass="form-control" name="txtCarnet" placeholder="2018LR601" Enabled="false"></asp:TextBox>
                                    </div>
                                    <div class="input-group my-4">
                                        <label for="txtResponsableApellido" class="mr-2">Resposable Apellido:</label>
                                        <asp:TextBox ID="txtResponsableApellido" runat="server" CssClass="form-control" name="txtCarnet" placeholder="2018LR601" Enabled="false"></asp:TextBox>
                                    </div>
                                    <div class="input-group my-4">
