                                       ...
                                       <div class="row py-3 px-4">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <asp:GridView ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" CellPadding="4" DataKeyNames="idAlumno" DataSourceID="SqlDataSource3" ForeColor="#333333" GridLines="None" Width="100%" CssClass="table-responsive">
